...
public class ViewEditKitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_edit_kit);
        ...
        ListView kitView = (ListView) findViewById(R.id.list_view_edit_a_kit);
        ...
        kitView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // this method starts an intent that starts EditKitActivity
